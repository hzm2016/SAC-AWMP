...
def main(arg):
    ...
    for i in trange(arg.n_exp):
        ...
        reward, steps = run_experiment(SAC_actor, buffer, v_critic, target_v_critic, softq_critic,
                                       env, arg.freq, v_optimizer, q_optimizer, actor_optimizer,
                                       arg.discount, arg.max, arg.n_epi)
...
if __name__ == '__main__':
    ...
    argparser.add_argument('-n', '--n_exp', type=int, default=1, help='Number of experiments (default: 20).')
